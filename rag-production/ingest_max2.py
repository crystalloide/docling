...
# (valeurs optimisées pour RTX 3090 24 Go) ────────────────────────
EMBED_BATCH         = 196   # ×2 — Ollama gère bien
UPSERT_BATCH        = 150   # ×2 — réseau local, pas de limite
LARGE_PDF_THRESHOLD = 100   # moins de découpage inutile
PAGES_PER_CHUNK     = 50    # moins d'allers-retours fichiers tmp
